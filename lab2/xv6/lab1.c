...
int main(int argc, char *argv[])
{
  ...
  if (atoi(argv[1]) == 1)
   ...
   printf(1, "\ntype \"lab1 1\" to test exit and wait, \"lab1 2\" to test waitpid, \"lab1 3\" to test the extra credit WNOHANG option, \"lab1 4\" to test priority scheduling, and \"lab1 5\" to test aging. \n");
